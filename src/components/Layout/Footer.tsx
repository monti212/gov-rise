...
export const Footer = () => {
  ...
  const socialLinks = [
    { label: 'WhatsApp', icon: <WhatsAppIcon />, href: 'https://wa.me/govrise', color: 'hover:text-green-500' },
    { label: 'Facebook', icon: <FacebookIcon />, href: 'https://facebook.com/govrise', color: 'hover:text-blue-600' },
    { label: 'LinkedIn', icon: <LinkedInIcon />, href: 'https://linkedin.com/company/govrise', color: 'hover:text-blue-700' },
    { label: 'X', icon: <XIcon />, href: 'https://x.com/govrise', color: 'hover:text-gray-900' },
  ];

  return (
    <footer className="bg-white border-t border-gray-200 py-3 px-4 md:px-6">
      <div className="flex flex-col md:flex-row items-center justify-between text-gray-500 text-sm gap-2">
        <div>
